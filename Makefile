...
PROGS       = afl-gcc neuzz afl-showmap afl-as
...
COMM_HDR    = alloc-inl.h config.h debug.h types.h neuzzconfig.h
...
neuzz: neuzz.c neuzzconfig.h | test_x86
	gcc -O3 -funroll-loops $@.c -o neuzz
